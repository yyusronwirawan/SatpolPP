        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card border-0 shadow rounded">
                    <div class="card-body">
                        <form action="{{ route('galery.update', $galery->slug) }}" method="POST"
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('title') is-invalid @enderror"
                                    name="title" value="{{ old('title', $galery->title) }}"
                            ...
                            <div class="form-group">
                                ...
                                <textarea id="summernote" class="form-control @error('body') is-invalid @enderror" name="body" rows="5"
                                    placeholder="Isi Galeri Kegiatan">{{ old('body', $galery->body) }}</textarea>
                            ...
                            <div class="form-group">
                                ...
                                <input type="file" class="form-control @error('image') is-invalid @enderror"
                                    name="image" value="{{ old('image', $galery->image) }}">
